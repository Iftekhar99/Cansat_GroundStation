 ...
 */
public class CanSatGroundStation extends javax.swing.JFrame {
...
//            Logger.getLogger(CanSatGroundStation.class.getName()).log(Level.SEVERE, null, ex);
//        }
//
//        //--for file setting
//        //---Altitude
...
//--PressureGraph
            ...
            public void run() {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        voltageLabel.setText(dataArray[5]);
                        gpsTimeLabel.setText(dataArray[6]);
                        softStateLabel.setText(dataArray[7]);
                        //-------
                        seriesAl.add(Integer.parseInt(dataArray[1]), Integer.parseInt(dataArray[2]));
                        seriesTemp.add(Integer.parseInt(dataArray[1]), Integer.parseInt(dataArray[4]));
                        seriesPressure.add(Integer.parseInt(dataArray[1]), Integer.parseInt(dataArray[3]));
                        seriesVolt.add(Integer.parseInt(dataArray[1]), Integer.parseInt(dataArray[5]));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CanSatGroundStation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CanSatGroundStation().setVisible(true);
            }
        });
    }
